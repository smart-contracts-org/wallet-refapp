...
export const CreateAssetAccountSuccess: React.FC<CreateAssetAccountSuccessProps> =
      ...
      <Card elevation={0} variant="outlined" className={classes.success}>
        <CardContent>
          ...
          <Typography variant="body2">
            You have successfully created Asset account for MAXCOIN Follow the
            next step to issue assets.
          </Typography>
          <Button
            sx={{ marginBottom: 1 }}
            fullWidth
