...
export const PendingAssetInviteRowContent: React.FC<PendingRowProps> = (
  props
) => {
  const { isInbound, sender, inboundTicker, receiver } = props;
  ...
  return (
    <>
      <div>{isInbound ? inboundMessage : outboundMessage}</div>
    </>
  );
};
