...
export const SwapForm: React.FC<SwapFormProps> = (props) => {
  ...
  const [inboundAssetType, setInboundAssetType] =
    React.useState<undefined | AssetType>();
      ...
      <div className={classes.root}>
        ...
        <Card elevation={0} variant="outlined" className={classes.helpMessage}>
          ...
          <Typography color="text.primary" variant="body2" p={1}>
            ...
            . A swap proposal sent to the Default Party is accepted
            automatically. The Default Party is a bot implemented using
            Triggers.
          </Typography>
          <Typography color="text.primary" variant="body2" p={1}>
            A swap proposal sent to the Default Party is accepted automatically.
