...
export const CreateAssetWorkflowDone: React.FC<CreateAssetWorkflowDoneProps> = ({onDoneClick, onNext}) => {
  ...
  return (
    <Card elevation={0} color='theme.success' className={classes.success}>
      <CardContent>
        ...
        <Typography>
          You have completed the steps. Go to "Issued by me" to see your issues.
        </Typography>
      </CardContent>
    </Card>
  )
